...
| ------------ | -------------- |
| 0.0.1-beta.3 | ✅ (current)   |

`0.0.1-beta.1` and `0.0.1-beta.2` are the earlier tags. Both are superseded
and receive nothing, including security fixes. Upgrade rather than asking for a
backport.
